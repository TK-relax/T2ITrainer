...
with gr.Blocks() as demo:
    ...
    with misc_accordion:
        ...
        with gr.Row():
            ...
            max_time_steps = gr.Number(label=get_text('max_time_steps'), value=default_config["max_time_steps"], info=get_text('max_time_steps_info'), maximum=100000000, minimum=0)
